...
(information about 'yellow' trips is used)
...
The data has some outliers in many of the features and some unique data distributions, from which valuable insights have been acquired.
